              ...
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
				  <?php
					...
					WHERE u.FILESTATUS='1' AND u.UPLOADER='".$_SESSION['userid']."' AND d.FILE_ID=u.FILEID";
                    $query = $conn->query($sql);
                      ...
                      ?>
                        <tr>
						  ...
						  <div class="dropdown-menu" role="menu">
							<!-- <a href="file_download.php?file_id=<?php echo $ID;?>" class="dropdown-item btn-sm "><span class="fa fa-download"></span> Donwload</a>
							 <a href="../uploads/<?php echo $FILENAME; ?>" class="dropdown-item btn-sm "><span class="fa fa-eye"></span> View</a>
							 --->
