          ...
          <div class="col-md-12">
			...
			<div class="card-footer card-comments">
			 <?php
				 ...
				 $sql = mysqli_query($conn,"SELECT * FROM tblcomment c INNER JOIN tbladmin a ON c.userid = a.id WHERE cfileid='$fileid' ORDER by submit_date DESC");
				 ...
				 if($row > 0 ){
					...
					?>
					<!-- <div class="timeline-footer">
                    <a href="file_allcomment.php?allcoment=<?php echo $fileid;?>">  <i class="fas fa-eye"></i> Show All comment</a>
                  </div>--->
				</div>
