      ...
      <div class="container-fluid">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                  <div class="btn-group" id="realtime" data-toggle="btn-toggle">
					<a type="button" href="files_upload.php" class="btn bg-gradient-success btn-sm"><i class="fa fa-upload" aria-hidden="true"></i> Upload File</a>
                  </div>
                </div>
              </div>
            <!-- /.card-header -->
            <div class="card-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
				  <?php
                    $sql = "SELECT * FROM upload_files u INNER JOIN tbladmin a ON u.UPLOADER=a.id WHERE UPLOADER= '".$_SESSION['userid']."' AND FILESTATUS='0'";
                    $query = $conn->query($sql);
                    while($row = $query->fetch_assoc()){
						 ...
						 $uploaddate =$row['DATETIME'];
						    ...
						    $sql = "SELECT COUNT(TO_USERID) AS Totaluser FROM tblfileshare WHERE FILE_SHAREID='$ID'";
                        ...
                        <tr>
						 ...
						 <td><?php echo $FILENAME; ?>
						  ...
						  <div class="dropdown-menu" role="menu">
						    <a href="file_share.php?file_id=<?php echo $ID;?>" class="dropdown-item btn-sm "><span class="fa fa-user-plus text-primary"></span> Share</a>
							  <a href="file_comment.php?file_id=<?php echo $ID;?>" class="dropdown-item btn-sm "><span class="fa fa-comment text-warning"></span> Comments</a>
							 ...
							 <a href="../uploads/<?php echo $FILENAME; ?>" class="dropdown-item btn-sm "><span class="fa fa-eye text-info"></span> View</a>
							  ...
							  <a href="myfiles.php?del=<?php echo $ID;?>" class="dropdown-item" onClick="return confirm('Do you really want to delete?')"><span class="fa fa-trash text-danger"></span> Delete</a> 
                          ...
                          <td>
							  ...
							  <span><?php echo $totaluser;?></span> <a href="file_share_to.php?file_id=<?php echo $ID;?>"><i class="fas fa-eye-slash"></i></a>
                          <td>
							<?php
