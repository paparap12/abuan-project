						 ...
						 <td><?php echo $FILENAME; ?>
						  ...
						  <div class="dropdown-menu" role="menu">
							 ...
							 <a href="../uploads/<?php echo $FILENAME; ?>" class="dropdown-item btn-sm "><span class="fa fa-eye text-info"></span> View</a>
							  ...
							  --->
							  <a href="myfiles_delete_submit.php?del=<?php echo $ID;?>" class="dropdown-item" onClick="return confirm('Do you really want to delete?')"><span class="fa fa-trash text-danger"></span> Delete</a>
